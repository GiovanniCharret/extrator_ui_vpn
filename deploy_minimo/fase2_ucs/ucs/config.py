...
# Colunas de projeto — opcionais na saída (via --dados-projetos); usadas só como rastreio.
COL_COD_PROJETO = "PPC_Cod_Projeto"   # código do projeto
COL_NOME_PROJETO = "PPC_Nome_Projeto"  # nome/descrição do projeto
